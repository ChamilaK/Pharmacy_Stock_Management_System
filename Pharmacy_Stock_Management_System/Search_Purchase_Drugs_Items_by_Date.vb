...
Public Class Search_Purchase_Drugs_Items_by_Date
    ...
    Private Sub ButtonSearch_Click(sender As Object, e As EventArgs) Handles ButtonSearch.Click
        ...
        Dim command As New MySqlCommand("SELECT * FROM `purchased_drugs_items` WHERE `Date_of_Purchase` BETWEEN @d1 AND @d2", connection)
